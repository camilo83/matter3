...
export function AliancesSlider() {
  const logos = [
    { src: itmLogo, alt: 'ITM', link: 'https://www.itm.edu.co/' },
    { src: mammLogo, alt: 'MAMM', link: 'https://www.elmamm.org/' },
    {
      src: alcaldia,
    ...
    },
    {
      src: beyondMatter,
      alt: 'Beyond Matter',
      link: 'https://beyondmatter.eu/about',
    },
    { src: avh, alt: 'AVH', link: 'https://www.avhmedellin.co/' },
    {
      src: pascualBravo,
      alt: 'Pascual Bravo',
    ...
    },
    {
      src: prohelvetia,
      alt: 'Prohelvetia',
      link: 'https://prohelvetia.ch/en/',
    },
    {
      src: goethe,
      alt: 'Goethe',
      link: 'https://www.goethe.de/ins/co/es/index.html',
    },
  ];
  return (
    <div className="logos">
      <Marquee duration={30000} pauseOnHover={true} className="logos-marquee">
